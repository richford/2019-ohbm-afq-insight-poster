...
{\vspace{0.5em} Adam Richie-Halford\textsuperscript{1}, Ariel Rokem\textsuperscript{2} \hspace{14.2em} Poster W763 \\ % Author names
{\smaller 1. Dept. of Physics, 2. The eScience Institute, University of Washington, Contact: richford@uw.edu}} % Author email addresses
...
% \color{DarkSlateGray} % Set the color back to DarkSlateGray
...
\headerbox{Results: Classifying ALS patients}{name=results1,span=2,column=1,row=0}{ % To reduce this block to 1 column width, remove 'span=2'
